...
export class Backend implements backendInterface {
    ...
    async addCafe(arg0: bigint, arg1: string, arg2: City, arg3: Area, arg4: string, arg5: [number, number]): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCafe(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getCafeById(arg0: bigint): Promise<Cafe> {
        if (this.processError) {
            try {
                const result = await this.actor.getCafeById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listCafes(): Promise<Array<Cafe>> {
        if (this.processError) {
            try {
                const result = await this.actor.listCafes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchCafes(arg0: string, arg1: string | null, arg2: string | null): Promise<Array<Cafe>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchCafes(arg0, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n1(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
